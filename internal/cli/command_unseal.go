...
// UnsealCommand представляет собой команду для разблокировки сервера. Для полного ансила сервера необходимо выполнить команду с 3 ключами.
// Если были переданы неправильные ключи, то процесс разблокировки сбрасывается и необходимо выполнить команду снова.
