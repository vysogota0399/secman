...
func TestNewCommandPCI_DSS(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := NewCommandPCI_DSS()
			if got.FSet.Name() != tt.want.FSet.Name() {
				t.Errorf("NewCommandPCI_DSS() FSet name = %v, want %v", got.FSet.Name(), tt.want.FSet.Name())
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := c.Parse(tt.args.args); (err != nil) != tt.wantErr {
				t.Errorf("CommandPCI_DSS.Parse() error = %v, wantErr %v", err, tt.wantErr)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := c.Handle(tt.args.ctx, tt.args.b, tt.args.o); (err != nil) != tt.wantErr {
				t.Errorf("CommandPCI_DSS.Handle() error = %v, wantErr %v", err, tt.wantErr)
			}
		})
	}
}
