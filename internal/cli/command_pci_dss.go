...
var _ ICommand = &CommandPCI_DSS{}

func NewCommandPCI_DSS() *CommandPCI_DSS {
	c := &CommandPCI_DSS{
...
func (c *CommandPCI_DSS) Info() string {
	return "PCI-DSS command for managing PCI-DSS secrets by secret tokens"
}

func (c *CommandPCI_DSS) Parse(args []string) error {
	if len(args) < 2 {
		c.FSet.Usage()
		return nil
	}
...
func (c *CommandPCI_DSS) Handle(ctx context.Context, b *strings.Builder, o *Operation) error {
	switch c.operation {
	case "write":
...
func (c *CommandPCI_DSS) write(ctx context.Context, b *strings.Builder, o *Operation) error {
	if c.pan == "" {
...
func (c *CommandPCI_DSS) read(ctx context.Context, b *strings.Builder, o *Operation) error {
...
func (c *CommandPCI_DSS) update(ctx context.Context, b *strings.Builder, o *Operation) error {
	if c.panToken == "" {
		return errors.New("PAN token is required")
	}
...
func (c *CommandPCI_DSS) delete(ctx context.Context, b *strings.Builder, o *Operation) error {
	if c.panToken == "" {
		return errors.New("PAN token is required")
	}
