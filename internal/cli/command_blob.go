...
// BlobCommand представляет собой команду для управления секретами в формате blob. Доступные команды:
// - write <file_path> - записывает файл в сервис и возвращает токен
// - read <token> - читает файл из сервиса и сохраняет его в указанную директорию, если указан флаг -m, то выводит метаданные
// - delete <token> - удаляет файл из сервиса
// - update <token> <key>=<value> - обновляет метаданные файла
// - list - выводит список всех токенов
