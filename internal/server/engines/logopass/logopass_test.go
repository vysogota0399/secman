...
import (
	...
	logopass_repos "github.com/vysogota0399/secman/internal/server/engines/logopass/repositories"
	"github.com/vysogota0399/secman/internal/server/iam"
	iam_repos "github.com/vysogota0399/secman/internal/server/iam/repositories"
		...
		},
		{
			...
			setup: func() {
				mockIam.EXPECT().
					...
					Return(iam_repos.User{}, server.ErrEntryNotFound)
			},
		},
	}
	for _, tt := range tests {
